...
// Sq8uL2BatchPerDimensionAvx computes squared L2 distance with per-dimension scaling.
// query: float32 query vector (dim)
...
// n: number of vectors
// out: output distances (n)
void sq8uL2BatchPerDimensionAvx(const float *__restrict__ query, const uint8_t *__restrict__ codes,
