...
// out: output distance
void squaredL2Int8DequantizedAvx2(const float *__restrict__ query,
...
// buildDistanceTableInt8Avx2 fills out[0:256] with distances between query and all
// 256 int8 centroids in codebook.
// codebook is laid out as 256 consecutive centroids, each of length subdim.
void buildDistanceTableInt8Avx2(const float *__restrict__ query,
...
// findNearestCentroidInt8Avx2 returns the index (0..255) of the closest centroid.
void findNearestCentroidInt8Avx2(const float *__restrict__ query,
                               const int8_t *__restrict__ codebook,
                               int64_t subdim,
                               const float *__restrict__ scale,
                               const float *__restrict__ offset,
