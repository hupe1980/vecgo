...
// SquaredL2BatchAvx computes squared L2 distance for a batch of vectors using AVX2.
...
void squaredL2BatchAvx(float *__restrict__ query, float *__restrict__ targets, int64_t dim, int64_t n, float *__restrict__ out) {
...
// DotBatchAvx computes dot product for a batch of vectors using AVX2.
void dotBatchAvx(float *__restrict__ query, float *__restrict__ targets, int64_t dim, int64_t n, float *__restrict__ out) {
    for (int64_t i = 0; i < n; i++) {
        float *target = targets + i * dim;
